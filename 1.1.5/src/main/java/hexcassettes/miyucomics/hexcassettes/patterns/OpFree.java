...
public class OpFree implements SpellAction {
    ...
    public SpellAction.@NotNull Result executeWithUserdata(
        ...
        state.clampToMax(HexcassettesMain.MAX_CASSETTES);
        ...
        System.out.println("[Hexcassettes] Freed all cassettes");
        env.getWorld().playSound(null, player.blockPosition(), ModSounds.CASSETTE_EJECT.get(), SoundSource.PLAYERS, 1.0f, 1.0f);
